...
export default function BigGraph() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="764" height="150.322" viewBox="0 0 764 150.322">
            <defs>
                <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                    <stop offset="0" stopColor="var(--purpleAccent)" stopOpacity="0.5"/>
                    <stop offset="1" stopColor="var(--purpleAccent)" stopOpacity="0"/>
                </linearGradient>
            </defs>
